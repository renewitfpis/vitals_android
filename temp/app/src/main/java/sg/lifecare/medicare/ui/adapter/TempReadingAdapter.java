...
public class TempReadingAdapter extends ArrayAdapter<Temperature> implements ListAdapter
{   private String TAG = "BloodPressureReadingAdapter";
    ...
    public TempReadingAdapter(Context context, int layout, ArrayList<Temperature> list)
    {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        final Temperature weight = getItem(position);
        ...
        tvReading.setText(weight.getValue()+"");
