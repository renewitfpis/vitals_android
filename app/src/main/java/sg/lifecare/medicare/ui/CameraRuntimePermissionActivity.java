...
public class CameraRuntimePermissionActivity extends AppCompatActivity {
    ...
    public static void startActivity(@NonNull final Fragment fragment,
        ...
        final Intent intent = new Intent(fragment.getActivity(), CameraRuntimePermissionActivity.class);
    ...
    private ArrayList<String> getPermissionNeeded(@NonNull final ArrayList<String> reqPermissions) {
        ...
        for (String reqPermission : reqPermissions) {
            if (ContextCompat.checkSelfPermission(CameraRuntimePermissionActivity.this, reqPermission)
    ...
    private ArrayList<String> getPermissionRationaleNeeded(@NonNull final ArrayList<String> permissionsNeeded) {
        ...
        for (String permissionNeeded : permissionsNeeded) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(
                CameraRuntimePermissionActivity.this, permissionNeeded)) {
    ...
    private void showPermissionRationaleDialog(final String message, final String[] permissions) {
        new AlertDialog.Builder(CameraRuntimePermissionActivity.this)
            .setMessage(message)
            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    CameraRuntimePermissionActivity.this.requestForPermission(permissions);
                }
            })
            .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    CameraRuntimePermissionActivity.this.sendResult(false);
                }
            })
    ...
    private void requestForPermission(final String[] permissions) {
        ActivityCompat.requestPermissions(CameraRuntimePermissionActivity.this, permissions, REQUEST_CODE);
    }
