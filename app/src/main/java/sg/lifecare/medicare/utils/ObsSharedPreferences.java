...
public class ObsSharedPreferences implements SharedPreferences {
    ...
    private static ObsSharedPreferences prefs = null;
     ...
     */
    public ObsSharedPreferences(Context context, SharedPreferences delegate) {
     ...
     * @return
     */
    public synchronized static ObsSharedPreferences getPrefs(Context c, String appName, int contextMode) {
        if (prefs == null) {
            ...
            prefs = new ObsSharedPreferences(
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        public Editor() {
            this.delegate = ObsSharedPreferences.this.delegate.edit();
        }
